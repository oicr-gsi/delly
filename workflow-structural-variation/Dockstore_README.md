...
cp /pipeline/recipes/delly_data_modules_prep.yaml code/gsi/data_modules_recipe_prep.yaml
...
cp /pipeline/recipes/delly_data_modules.yaml data/gsi/data_modules_recipe.yaml
